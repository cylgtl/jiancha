...
<div class="easyui-layout" fit="true">
  ...
  <c:if test="${not empty manager || not empty vistor}">
   <t:datagrid name="reportList" title="实时举报" fitColumns="false"  actionUrl="reportController.do?datagrid&notFiter=1&type=${type}" idField="id" fit="true">
  ...
  <t:datagrid name="reportList" title="实时举报" fitColumns="false"  actionUrl="reportController.do?datagrid&isFilter=1&type=${type}" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="标题" field="title" width="180" align="center"></t:dgCol>
    <t:dgCol title="标题" field="title" width="180" align="center"></t:dgCol>
   <t:dgCol title="url" field="url" hidden="true"></t:dgCol>
